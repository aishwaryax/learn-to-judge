...
# sbatch scripts/nectar.sh train /project/pi_wenlongzhao_umass_edu/1/jkarnuthala/experiment_results/llama370b/nectar/asbolute_train.csv /datasets/ai/llama3/hub/models--meta-llama--Meta-Llama-3.1-70B-Instruct/snapshots/33101ce6ccc08fa6249c10a543ebfcac65173393 absolute

# bash scripts/nectar.sh train /project/pi_wenlongzhao_umass_edu/1/jkarnuthala/experiment_results/prometheusv2/nectar/nectar_prometheus7b_train.csv /project/pi_wenlongzhao_umass_edu/1/models/models--prometheus-eval--prometheus-7b-v2.0/snapshots/66ffb1fc20beebfb60a3964a957d9011723116c5 absolute
