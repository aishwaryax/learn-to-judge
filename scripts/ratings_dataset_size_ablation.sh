...
python ablations/ratings_dataset_size_ablation.py --train_path $train_path --test_path $test_path --train_emb_path $train_emb_path --test_emb_path $test_emb_path --experiment_folder $experiment_folder