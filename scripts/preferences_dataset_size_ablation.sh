...
python ablations/preferences_dataset_size_ablation.py --relative_train_path $relative_train_path --relative_test_path $relative_test_path --relative_train_emb_path $relative_train_emb_path --relative_test_emb_path $relative_test_emb_path --absolute_train_path $absolute_train_path --absolute_test_path $absolute_test_path --absolute_train_emb1_path $absolute_train_emb1_path --absolute_train_emb2_path $absolute_train_emb2_path --absolute_test_emb1_path $absolute_test_emb1_path --absolute_test_emb2_path $absolute_test_emb2_path --experiment_folder $experiment_folder